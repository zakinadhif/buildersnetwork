...
export const SCREEN_META: ScreenMeta[] = [
  ...
  },
  {
    ...
    productStatus: "active",
    scopeNote:
      "Transitional directory; feed-only activity, ordering, and seeker elements still need removal",
  },
  {
    key: "people",
    label: "People",
  ...
  },
  {
    ...
    productStatus: "retired",
    groundedBy: 106,
    scopeNote: "Historical reference for interest management",
  },
  {
    key: "auth",
    label: "Masuk / Daftar",
    ...
    productStatus: "active",
    groundedBy: 101,
    scopeNote: "Registration and email verification",
  },
  {
    key: "mulai",
    ...
    productStatus: "active",
    groundedBy: 102,
    scopeNote: "Minimal profile form",
  },
  {
    key: "onboarding",
    label: "Onboarding AI",
  ...
  },
  {
    ...
    groundedBy: 103,
    scopeNote:
      "Shell, karya identity, members, stages, screenshots, and update stream",
    excludes: [
      "post kinds",
      "appreciation",
  ...
  },
  {
    ...
    productStatus: "active",
    groundedBy: 104,
    scopeNote: "Manual and optional AI-assisted karya creation",
  ...
  },
  {
    ...
    productStatus: "active",
    groundedBy: 105,
    scopeNote: "Member identity, interests, skills, karya, and activity",
