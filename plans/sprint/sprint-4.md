...
- [ ] **FR-25** Project discovery page — browsable, grouped listings (featured, recent, by interest). Replaces the bare members-list as the projects home.
- [ ] **FR-44** Search page — karya by interest; people by skill/interest.

**Exit:** a member can both scroll groupings and run a targeted query.
