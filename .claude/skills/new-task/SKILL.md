...
| `[Diskusi]` | A question to decide *before* building — a decision to make; a vision/requirements/roadmap/milestone change. Strategic. | Proposed |
